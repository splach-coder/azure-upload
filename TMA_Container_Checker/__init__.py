...
from TMA_Container_Checker.functions import extract_text_from_pdf
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        isContainerExist = True if "CONTAINERS:".lower() in pdf_text.lower() else False

        try:
            # Prepare the JSON response
            response = {
                "contains_container": isContainerExist 
            }
