...
def extract_info_from_proforma(text):
    ...
    {{
        "HSCode": "...",
        "ToAddress": [
            "company name exp: CVB Recycling ",
            "street: Radiatorenstraat 51",
            "city: 1800",
            "postal code: Vilvoorde",
...
def detect_sender_flow(email_text: str) -> str:
    if "From: Dieter Decorte <dieter.decorte@coolsolutions.be>" in email_text and \
       "To: Import <import@dkm-customs.com>" in email_text:
        return "coolsolutions"
    elif "From: Bethany Bozzoni <bethany@williamsrecycling.co.uk>" in email_text and \
         "To: Import <import@dkm-customs.com>" in email_text:
