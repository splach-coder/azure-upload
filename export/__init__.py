...
from export.helpers.functions import write_to_excel, extract_key_value_pairs, extract_text_from_pdf, modify_and_correct_amounts, extract_kantoor_number
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        body_number = extract_kantoor_number(body)
