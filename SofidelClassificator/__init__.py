...
from SofidelClassificator.functions import extract_text_from_pdf
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        isSofidelInv = True if "COMMERCIAL PROFORMA INVOICE".lower() in pdf_text.lower() else False

        try:
            # Prepare the JSON response
            response = {
                "contains_invoice": isSofidelInv  # Sending the array of XML strings
            }
